...
public class Velocity {
    ...
    public Velocity( 
        ...
        // left master, right master, left follow, right follow
        ...
        //IntegratedSensor.toFeedbackDevice(); //Local Feedback Source
    ...
    public void velPeriodic(double speed, double turn, boolean vel) {
        ...
        double target_RPM = speed;	// +- 1000 RPM
        double target_unitsPer100ms = target_RPM * Constants.kSensorUnitsPerRotation / 600.0;
        double target_turn = turn;

        if (vel) {
            _rightMaster.set(target_unitsPer100ms);
